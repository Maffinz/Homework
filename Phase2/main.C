...
{
	FILE *source, *opcode, *intermediate, *symTable;
	char label[50], mnemonic[50], operand[50], tr[100];
	...
	//Assuming it starts with START
	fscanf(source, "%s %s %d %s", label, mnemonic, startAddress, tr);
